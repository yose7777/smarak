...
void _listenHistory() {
  ...
  String _mapImage(String? namaAlat) {
    ...
    if (name.contains('gerinda')) return 'assets/alat/alat1.png';
    if (name.contains('amplas')) return 'assets/alat/alat3.png';
    if (name.contains('bor')) return 'assets/alat/alat2.png';
